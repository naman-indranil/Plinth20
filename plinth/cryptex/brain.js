...
function PxLoaderSound(a, b, c, d) {
  ...
  function (a) {
      ...
      b = function () {
          ...
          return d || (d = 0), c.slideCount <= c.options.slidesToShow ? (c.$slider.find(".slick-slide").removeClass("slick-active").attr("aria-hidden", "true"),
              c.$slides.eq(d).addClass("slick-active").attr("aria-hidden", "false"), c.options.centerMode === !0 && (c.$slider.find(".slick-slide").removeClass("slick-center"), c.$slides.eq(d).addClass("slick-center")), void c.asNavFor(d)) : void c.slideHandler(d)
  ...
  function (a, b, c) {
      ...
      function o(b) {
          ...
          var c = a(".option.slick-center").data("id");
          y(c)
      }
      ...
      function t(b) {
          r();
          var c = parseInt(a(this).data("slick-index"));
          a("#stages-list").slick("slickGoTo", c), u()
      }
